...
public class AuthorService {
     ...
     * This is used for when a mock AuthorDAO that exhibits mock behavior is used in
     * the test cases.
    ...
    /**
     * TODO: Use the AuthorDAO to persist an author. The given Author will not have
     * an id provided.
     *
